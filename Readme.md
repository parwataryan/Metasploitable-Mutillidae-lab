...
<img width="766" height="185" alt="Image" src="https://github.com/user-attachments/assets/d619c310-943a-4108-a5d2-d9a4293ad27e" />

After change it will look like

<img width="744" height="180" alt="Image" src="https://github.com/user-attachments/assets/2cb75e16-96ea-41ba-9cc9-25f41bc9e994" />
...
ifconfig
```
Note down the IP address (example: 192.168.239.130)
...
Example: 
http://192.168.239.130/mutillidae
